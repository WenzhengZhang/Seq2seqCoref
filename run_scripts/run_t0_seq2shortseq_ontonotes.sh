...
DATA_DIR=$ROOT_DIR"data/ontonotes/mark_sentence"
#SAVE_DIR="t5_3b_predicts"
#MODEL_NAME="t5-3b"
MODEL_NAME="bigscience/T0_3B"
#MODEL_NAME="google/flan-t5-xl"
SAVE_DIR=$ROOT_DIR"predicts/short_seq/t0_3b/ontonotes/mark_sentence/"
...
warmup=0.1
#model="t5_3b_model"
model=$ROOT_DIR"model/short_seq/t0_3b/ontonotes/mark_sentence/"
#model="flan_t5_xl_model"
#logs="t5_3b_logs"
logs=$ROOT_DIR"logs/short_seq/t0_3b/ontonotes/mark_sentence/"
...
deepspeed main_trainer.py \
    --output_dir $model  \
    --model_name_or_path $model/checkpoint-38400 \
    --do_train  \
    --save_strategy steps  \
