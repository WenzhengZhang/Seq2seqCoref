...
SAVE_DIR=$ROOT_DIR"predicts/action/t0_3b/ontonotes/"
...
warmup=0.1
#model="t5_3b_model"
model=$ROOT_DIR"model/action/t0_3b/ontonotes/"
#model="flan_t5_xl_model"
#logs="t5_3b_logs"
logs=$ROOT_DIR"logs/action/t0_3b/ontonotes/"
...
seq_type="action"
eval_model="/common/users/wz283/asp_tag/generate_coref/t0_3b_model/ds_t0/"
