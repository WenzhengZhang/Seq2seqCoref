...
SAVE_DIR=$ROOT_DIR"predicts/tagging/t0_3b/ontonotes/"
...
warmup=0.1
#model="t5_3b_model"
model=$ROOT_DIR"model/tagging/t0_3b/ontonotes/"
#model="flan_t5_xl_model"
#logs="t5_3b_logs"
logs=$ROOT_DIR"logs/tagging/t0_3b/ontonotes/"
...
deepspeed main_trainer.py \
    ...
    --mark_sentence False \
    --resume_from_checkpoint $model/checkpoint-38400
#    --align_mode l \
