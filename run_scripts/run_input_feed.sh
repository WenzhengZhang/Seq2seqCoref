...
#deepspeed main_trainer.py \
torchrun --nproc_per_node=$n_gpu --standalone --nnodes=1 main_input_feed.py \
    --output_dir $model/input_feed  \
    ...
    --data_dir $DATA_DIR \
    --save_dir $SAVE_DIR/input_feed \
    --per_device_train_batch_size $train_bsz  \
    --per_device_eval_batch_size $eval_bsz \
    --learning_rate $lr \
    --num_train_epochs $epochs  \
    --logging_dir $logs/input_feed \
    ...
    --eval_delay 36000
#    --resume_from_checkpoint $model/input_feed/checkpoint-36600
